           //This is the java script code for the cart page:
var slideIndex = 1;
showDivs(slideIndex);
...
//       }
    ...
    $(".total-amount").text(function(){
     ...
     var last = "£ " + total.toFixed(2); // this line 140 is where I changed the money symbol from a dollar sign to pounds sign 
     $('.pay-last').text(last);
